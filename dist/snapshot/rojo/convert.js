function convertExplicitRojoProperty(typeStr, value) {
...
export function convertImplicitRojoProperty(propName, val) {
    ...
    if (Array.isArray(val)) {
        ...
        const allArraysOfTwo = val.every((v) => Array.isArray(v) &&
            v.length >= 2 &&
        ...
        const allKeypointObjects = val.every((v) => typeof v === "object" &&
            v !== null &&
            !Array.isArray(v) &&
            ("time" in v || "Time" in v) &&
